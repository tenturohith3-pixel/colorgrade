...
export default function ColorToolPage() {
  ...
  const reset = () => {
    ...
    // Re-render canvas without grading
    if (canvasRef.current && imageRef.current) {
      renderCanvas();
    }
  };

  // Canvas rendering with real color grading
  const renderCanvas = useCallback(() => {
    ...
    // Apply color grading via Canvas pixel manipulation
    ...
    <div className="min-h-screen bg-[#0a0a0c]">
      ...
      <div className="flex h-[calc(100vh-56px)]">
        ...
        <main className="flex-1 flex flex-col">
          ...
          {/* Canvas */}
          <div className="flex-1 flex items-center justify-center p-8 bg-[#08080a] relative overflow-hidden">
            {/* Grid background */}
            <div
